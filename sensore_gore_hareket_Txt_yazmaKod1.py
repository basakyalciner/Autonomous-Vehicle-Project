...
#------------------------------------------------------------------------#
# PWM temel alınarak yazılan kontrol kod.
# Burada hedeflenen amaç ileri ve geri hareketlerde ederken aracın  
#çarpmasını önleyecek bir kod tasarlandı.
#------------------------------------------------------------------------#
...
#------------------------------------------------------------------------#
#Bu kısımda sensörden alınan bilgilere göre ve yönler belirlenerek 
#aracın hareket etme kodları yazıldı(yukarıda motor fonksiyonları kullanıldı)
#Ayrıca oluşturulan bu kodda 10x10 luk matris oluşturularak verilen 
#labirentin mazini oluşturma kısmıda yer almakta ilerleme durumuna göre
#matrise bulunan a,b konumunda sıfır konuldu ve gerekli yerlere ise 1 lerden
#oluşan satır ve sutun matrisleri konularak maze genişletildi sonuç olarak
#istenilen hedefe ulaşldı.
#---------------- Sensörlere göre hareket ve tarama -------------------------#
a,b = 1,1 
start_a,start_b = 1,1 
maze = np.ones((10,10)) 
maze[1,1] = 0 
...
while True: 
    ...
    if sol_sensor > 10: 
        ...
        time.sleep(1)
#------------ Tarama işlemi için Matris genişletme işlemi ---------------#
    if b == 0:     
    ...
    if a == start_a and b == start_b: 
        break 
# Bu kısımda taranan maze'nin matrisi bir txt dosyasına yazıldı #
